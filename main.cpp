 ...
 * @date 2024-12-07
 * @brief testing employee supervisor and officer classes
 */
#include <iostream>
#include "Employee.h"
...
/**
 * @brief runs tests on employee object
 *
 * tests print calculatePay and anniversary functions on employee object
 *
 * @param e the employee object to test
 * @pre employee object must be initialized
 * @post employee functions are tested and output is printed
 */
